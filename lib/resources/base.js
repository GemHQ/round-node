...
(function() {
  ...
  module.exports = Base = (function() {
    ...
    Base.prototype.getAssociatedCollection = function(_arg) {
      var collectionClass, collectionInstance, fetch, name, options, resource;
      collectionClass = _arg.collectionClass, name = _arg.name, options = _arg.options, fetch = _arg.fetch;
