...
(function() {
  ...
  module.exports = Account = (function() {
    function Account(resource, client, options) {
      ...
      this.name = resource.name, this.balance = resource.balance, this.path = resource.path, this.pending = resource.pending, this.rules = resource.rules, this.subscriptions = resource.subscriptions;
    ...
    Account.prototype.pay = function(content, callback) {
      var confirmations, multiWallet, payees;
      payees = content.payees, confirmations = content.confirmations;
      if (!payees) {
      ...
      return this.payments().unsigned(payees, confirmations, function(error, payment) {
        if (error) {
          return callback(error);
        }
