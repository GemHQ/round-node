...
(function() {
  ...
  module.exports = Account = (function(_super) {
    ...
    function Account(_arg) {
      ...
      this.wallet = wallet;
      this.name = resource.name, this.balance = resource.balance, this.path = resource.path, this.pending = resource.pending, this.network = resource.network, this.key = resource.key, this.pending_balance = resource.pending_balance, this.available_balance = resource.available_balance;
    }
    ...
    Account.prototype.transactions = function(_arg) {
      var fetch, query, _ref;
      _ref = _arg != null ? _arg : {}, fetch = _ref.fetch, query = _ref.query;
      return this.getAssociatedCollection({
