...
(function() {
  ...
  module.exports = Collection = (function() {
    ...
    Collection.prototype.loadCollection = function(_arg) {
      var options, query, resource, _ref;
      _ref = _arg != null ? _arg : {}, options = _ref.options, query = _ref.query;
      if (options == null) {
        options = {};
      }
      if (query == null) {
      ...
      return resource.list().then((function(_this) {
        return function(data) {
          var key, model, resourceArray, _i, _len, _ref1;
