...
(function() {
  ...
  module.exports = User = (function(_super) {
    ...
    function User(_arg) {
      ...
      this.email = resource.email, this.url = resource.url, this.first_name = resource.first_name, this.last_name = resource.last_name, this.user_token = resource.user_token, this.default_wallet = resource.default_wallet, this.key = resource.key;
    }
