...
(function() {
  var Account, Accounts, AssetTypes, Base, CoinOp, MultiWallet, PassphraseBox, Wallet, promisify,
  ...
  module.exports = Wallet = (function(_super) {
    ...
    Wallet.prototype.assetTypes = function(_arg) {
      var fetch;
      fetch = (_arg != null ? _arg : {}).fetch;
      return this.getAssociatedCollection({
    ...
    Wallet.prototype.balancesFor = function(_arg) {
      var asset_type, network, utxo_confirmations;
      asset_type = _arg.asset_type, utxo_confirmations = _arg.utxo_confirmations, network = _arg.network;
      if (!asset_type) {
        throw new Error('You must supply asset_type: key');
      }
      if (utxo_confirmations == null) {
        utxo_confirmations = 0;
      }
      if (network == null) {
        network = 'bcy';
      }
      this.resource.available = promisify(this.resource.available);
