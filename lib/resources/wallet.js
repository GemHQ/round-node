...
(function() {
  var Accounts, Base, CoinOp, MultiWallet, PassphraseBox, Wallet, promisify,
  ...
  module.exports = Wallet = (function(superClass) {
    ...
    Wallet.prototype.unlock = function(arg) {
      ...
      return PassphraseBox.decrypt(passphrase, this.resource.primary_private_seed).then((function(_this) {
